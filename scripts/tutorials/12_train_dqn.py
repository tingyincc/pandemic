...
def get_args():
    ...
    parser.add_argument('--target-update-freq', type=int, default=50) # this is every 500 UPDATES; test value=2
...
def train_dqn(args=get_args()):
    ...
    logger = TensorboardLogger(writer, 
        ...
        update_interval=5) # this interval is every NO UPDATES not no timesteps
